// Penggunaan jquery untuk memanggil api
...
searchButton.addEventListener("click", function () {
  ...
  // Keterangan fetch pada kolom adalah url
  fetch("http://www.omdbapi.com/?apikey=44465a5f&s=" + inputKeyword.value)
    // jika berhasil
    ...
    .then((response) => {
      ...
      modalDetailButton.forEach((btn) => {
        btn.addEventListener("click", function () {
          ...
          fetch("http://www.omdbapi.com/?apikey=44465a5f&i=" + imdbid)
            .then((response) => response.json())
            .then((movie) => {
              const movieDetail = showMovieDetail(movie);
